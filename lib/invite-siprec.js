  ...
  return async(req, res) => {
    ...
    try {
      ...
      const {uas, uac} = await srf.createB2BUA(req, res, dest, {
        ...
        localSdpA: produceSdpUas.bind(null, logger, bridgeA, bridgeB, answer, bridgeB.rtpEngineOpts.answer),
...
async function produceSdpUas(logger, bridgeA, bridgeB, answer, opts, remoteSdp, res) {
